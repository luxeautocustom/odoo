...
{
    'name': 'Backend Payment Acquirer: Authorize.net',
    'version': '1.0',
    'category': 'Accounting/Payment Acquirers',
    'summary': 'Payment Acquirer: Backend Authorize.net Implementation',
...
product
    ...
    'application': True,
    'auto_install': False,
    'post_init_hook': '_change_journal_account',
}
